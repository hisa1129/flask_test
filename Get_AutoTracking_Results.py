        ...
        if flag_tracking_was_done:
            try:                              
                ...
                result = {
                    ...
                    "num_contours_at_first":check_is_nan(num_first_contours),
                    "solidity[U]":check_is_nan(solidity),
                    "arc_solidity[u]":check_is_nan(arc_solidity),
                    "flag_droplet_faced":check_is_nan(str(flag_droplet_faced)),
                    "faced_delay[us]":check_is_nan(faced_delay),
                    "flag_droplet_separated":check_is_nan(str(flag_droplet_separated)),
